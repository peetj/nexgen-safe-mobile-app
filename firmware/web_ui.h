...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .steps{margin:0;padding-left:18px;color:rgba(242,242,240,.86);font-size:14px;line-height:1.5}
...
<body>
  ...
  <div class="wrap">
    ...
    <div class="card">
      <div class="hint" style="margin-bottom:8px">Phone setup</div>
      <ol class="steps">
        <li>Open your phone Wi-Fi settings and join the safe network shown as <b>NexgenSafe-XX</b>.</li>
        <li>If your phone says the network has no internet, stay connected.</li>
        <li>If this page does not open automatically, open Safari or Chrome and go to <b>http://192.168.4.1</b>.</li>
        <li>Tap <b>Unlock</b> or <b>Lock</b>, enter the 4-digit PIN, then tap <b>Go</b>.</li>
        <li>Use <b>Set PIN</b> to change the safe code.</li>
      </ol>
    </div>
    <div class="card">
      <div class="row">
